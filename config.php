<?php
// Твои настройки подключения к базе данных Supabase
define('DB_HOST', 'aws-0-eu-central-1.pooler.supabase.com');
define('DB_PORT', 6543);
define('DB_NAME', 'postgres');
define('DB_USER', 'postgres.db');
...
define('SUPABASE_BUCKET', 'my-4ch'); // Убедись, что бакет называется images и он public!
